                  ...
                  children: [
                    const Column(
                      children: [
                        ...
                        SizedBox(height: 30),
                        Text(
                            "Dapatkan Informasi Yang Tepat Sebelum\nMemutuskan Membuka Rekening Saham,\nAgar Dapat Memulai Dengan Benar.",
                            textAlign: TextAlign.start,
                            style: TextStyle(
                                color: Color.fromRGBO(0, 64, 119, 1),
                                fontSize: 24))
                  ...
                  children: [
                    Column(
                      children: [
                        ...
                        SizedBox(height: 30),
                        Text(
                            "Anda tidak perlu bingung mulai dari mana, perjalanan\ninvestasi dan trading anda dimulai dengan 5 langkah ini",
                            textAlign: TextAlign.center,
                            style: TextStyle(
                                color: Color.fromRGBO(0, 64, 119, 1),
                                fontSize: 24)),
